...
module.exports = "<h1>About</h1>\r\n\r\n<p>This is my diploma thesis and will be about containerizing microservices, test them by jenkins and deploy them to azure.</p>\r\n\r\n<p>Author: Johanna Rührig</p>\r\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__lorem_ipsum_loremipsum_component__ = __webpack_require__("./src/app/lorem-ipsum/loremipsum.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__logon_logon_component__ = __webpack_require__("./src/app/logon/logon.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_11__lorem_ipsum_loremipsum_component__["a" /* LoremIpsumComponent */],
                __WEBPACK_IMPORTED_MODULE_12__logon_logon_component__["a" /* LogonComponent */]
            ],
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_4__angular_router__["a" /* RouterModule */].forRoot([
                    ...
                    { path: 'lorem-ipsum', component: __WEBPACK_IMPORTED_MODULE_11__lorem_ipsum_loremipsum_component__["a" /* LoremIpsumComponent */] },
                    { path: '', component: __WEBPACK_IMPORTED_MODULE_7__home_home_component__["a" /* HomeComponent */], pathMatch: 'full' },
                    { path: 'logon', component: __WEBPACK_IMPORTED_MODULE_12__logon_logon_component__["a" /* LogonComponent */] }
                ])
            ],
            providers: [],
...
module.exports = "<h1>Logon</h1>\r\n\r\n<p>Username</p>\r\n<input/>\r\n\r\n<p>Password</p>\r\n<input type=\"password\"/>\r\n\r\n<button (click)=\"tryToLogon()\">Logon</button>\r\n\r\n<p><font color=\"red\">Failed attempts: {{failedAttempts}}</font></p>\r\n"
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return LogonComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_common_http__ = __webpack_require__("./node_modules/@angular/common/esm5/http.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
var LogonComponent = /** @class */ (function () {
    function LogonComponent(http, baseUrl) {
        this.http = http;
        this.baseUrl = baseUrl;
        this.failedAttempts = 0;
    }
    LogonComponent.prototype.tryToLogon = function () {
        var _this = this;
        this.http.get(this.baseUrl +
            'interface/logon/' +
            this.username +
            "/" +
            this.password).subscribe(function (result) {
            if (result[0] === "denied") {
    ...
    LogonComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            ...
            template: __webpack_require__("./src/app/logon/logon.component.html"),
        }),
        __param(1, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["z" /* Inject */])('BASE_URL')),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_common_http__["a" /* HttpClient */], String])
    ], LogonComponent);
...
/***/ "./src/app/lorem-ipsum/lorem-ipsum-generator-type.enum.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return LoremIpsumGeneratorType; });
var LoremIpsumGeneratorType;
(function (LoremIpsumGeneratorType) {
    LoremIpsumGeneratorType[LoremIpsumGeneratorType["Static"] = 1] = "Static";
    LoremIpsumGeneratorType[LoremIpsumGeneratorType["Dynamic"] = 2] = "Dynamic";
})(LoremIpsumGeneratorType || (LoremIpsumGeneratorType = {}));


/***/ }),

/***/ "./src/app/lorem-ipsum/loremipsum.component.html":
/***/ (function(module, exports) {

module.exports = "<h1>Lorem Ipsum Generator~</h1>\r\n\r\n<p>This is a Lorem Ipsum inspired generator - a microservice which is running on a totally different location, containerized, threadsafe, modulation-friendly, and powerful.</p>\r\n\r\n<form>\r\n  <p>\r\n    <button type=\"button\" class=\"btn btn-primary\" (click)=\"generate()\">Generate Text</button>\r\n    Mode;\r\n    <select (change)=\"onChange($event.target.value)\">\r\n      <option *ngFor=\"let key of keys\" [value]=\"key\">{{generators[key]}}</option>\r\n    </select>\r\n  </p>\r\n  <p>\r\n    <textarea readonly name=\"AreaToGenerateIn\" rows=\"10\" cols=\"25\" [(ngModel)]=\"areaToGenerateIn\"></textarea>\r\n  </p>\r\n  <p>\r\n    <button type=\"button\" class=\"btn btn-primary\" (click)=\"copyToClipboard()\">\r\n      <span class='glyphicon glyphicon-copy'></span>\r\n      Copy to Clipboard\r\n    </button>\r\n  </p>\r\n</form>\r\n"

/***/ }),

/***/ "./src/app/lorem-ipsum/loremipsum.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_common_http__ = __webpack_require__("./node_modules/@angular/common/esm5/http.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lorem_ipsum_generator_type_enum__ = __webpack_require__("./src/app/lorem-ipsum/lorem-ipsum-generator-type.enum.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var LoremIpsumComponent = /** @class */ (function () {
    function LoremIpsumComponent(http, baseUrl) {
        this.http = http;
        this.baseUrl = baseUrl;
        this.areaToGenerateIn = "Text will show up here";
        this.currentValue = __WEBPACK_IMPORTED_MODULE_2__lorem_ipsum_generator_type_enum__["a" /* LoremIpsumGeneratorType */].Static;
        this.generators = __WEBPACK_IMPORTED_MODULE_2__lorem_ipsum_generator_type_enum__["a" /* LoremIpsumGeneratorType */];
        this.keys = Object.keys(this.generators).filter(Number);
    }
    LoremIpsumComponent.prototype.onChange = function (currentValue) {
        this.currentValue = currentValue;
    };
    LoremIpsumComponent.prototype.copyToClipboard = function () {
        var _this = this;
        document.addEventListener('copy', function (e) {
            e.clipboardData.setData('text/plain', (_this.areaToGenerateIn));
            e.preventDefault();
            document.removeEventListener('copy', null);
        });
        document.execCommand('copy');
    };
    LoremIpsumComponent.prototype.generate = function () {
        var _this = this;
        this.http.get(this.baseUrl +
            'interface/lipsum_generator/' +
            __WEBPACK_IMPORTED_MODULE_2__lorem_ipsum_generator_type_enum__["a" /* LoremIpsumGeneratorType */][this.currentValue] +
            "/1/10").subscribe(function (result) {
            _this.areaToGenerateIn = result[0];
        }, function (error) { return console.error(error); });
    };
    LoremIpsumComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'app-lorem-ipsum-component',
            template: __webpack_require__("./src/app/lorem-ipsum/loremipsum.component.html"),
        }),
        __param(1, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["z" /* Inject */])('BASE_URL')),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_common_http__["a" /* HttpClient */], String])
    ], LoremIpsumComponent);
